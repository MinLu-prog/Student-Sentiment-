    ...
    >
      ...
      <main className="flex flex-1 items-center justify-center px-5 py-12 sm:px-8">
        <form onSubmit={handleSubmit} className="w-full max-w-sm text-left">
          <h1 className="mb-2 text-2xl font-bold tracking-tight sm:text-3xl">Log In</h1>
          <p className="mb-8 text-sm text-blue-100/80">
            Welcome back. Log in to like posts and join the discussion.
          </p>

          <div className="space-y-4">
            <div>
              <label htmlFor="login-email" className="mb-1.5 block text-xs font-semibold uppercase tracking-[0.1em] text-blue-200/80">
                Email
              </label>
              <Input
                id="login-email"
            ...
            <div>
              <label htmlFor="login-password" className="mb-1.5 block text-xs font-semibold uppercase tracking-[0.1em] text-blue-200/80">
                Password
              </label>
              <Input
                id="login-password"
